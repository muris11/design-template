---
name: design-template-monochrome
description: "Minimalist Monochrome design system — pure black & white editorial luxury. Use when user wants monochrome, black white, bw, minimalist monochrome, editorial, luxury, stark, serif, gallery, Vogue/Celine vibe, no accent colors."
allowed-tools: Read Write Edit Glob Grep
---
# design-template-monochrome

> Minimalist Monochrome — pure black & white editorial luxury. One template in `design-template` family. Copy this folder to create next template: `Copy-Item design-template-monochrome design-template-<nama>`.
...
- Load together with `design-template` core whenever task is monochrome UI.
...
- Never mix tokens from other templates. Monochrome = absolute #000/#FFF only.
- Checklist below must pass before delivering.

## Monochrome Checklist

Run alongside delivery. All must be **yes**:

- [ ] Palette strictly #FFFFFF / #000000 (+ #F5F5F5 / #525252 / #E5E5E5 only for muted/border). No accent color.
- [ ] Typography: Playfair Display for display, Source Serif 4 for body, JetBrains Mono for labels. Oversized hero at least 8xl.
- [ ] Border radius 0px everywhere. No rounded corners.
- [ ] Shadows NONE. Depth via inversion / border weight / scale only.
- [ ] Borders: hairline/thin/medium/thick/ultra system applied. Heavy 4px rules between sections.
- [ ] Textures applied (horizontal lines global + noise + section-specific grid/diagonal/vertical).
- [ ] Components: buttons rectangular, cards border 1px black, inputs 2px border → 4px on focus.
- [ ] Motion instant 0-100ms only, no bounce/parallax/slow easing.
- [ ] Icons Lucide 20px stroke 1.5 black only.
- [ ] Responsive: monochrome drama survives on mobile, 9xl → 5xl.
- [ ] Accessibility: 21:1 contrast, 3px focus outlines, 44px touch targets, skip links.
- [ ] 14 Bold Choices implemented (oversized hero, inverted stats, editorial quotes, drop cap, etc.).
